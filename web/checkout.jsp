                            ...
                            <div style="max-height: 400px; overflow-y: auto; padding-right: 5px;">
                                <c:forEach items="${sessionScope.cart.getSelectedItems()}" var="entry">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                        <img src="assets/images/${product.id}.jpg" alt="${product.tenSanPham}" class="order-item-img flex-shrink-0">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener("submit", function (event) {
                ...
                if (selected && selected.value === "banking") {
                    ...
                    alert("Chức năng thanh toán chuyển khoản đang phát triển. Vui lòng chọn COD!");
                    // Chuyển lại về COD
                    cod.checked = true;
                    return false;
                }
