    ...
    <section class="featured-section">
        <div class="container">
                    ...
                    <div class="product-card">
                        <c:if test="${product.hasDiscount()}">
                            <div class="product-badge sale">
                                -<fmt:formatNumber value="${product.discountPercentage}" pattern="#"/>%
                            </div>
                        </c:if>
                        ...
                        <div class="product-image">
                            ...
                            <div class="product-overlay">
                                <button onclick="addToCart(${product.productId})" class="btn-icon" title="Thêm vào giỏ">
                                    <i class="fas fa-shopping-cart"></i>
                                </button>
                                <button onclick="addToWishlist(${product.productId})" class="btn-icon" title="Yêu thích">
                        ...
                        <div class="product-info">
                            ...
                            <button onclick="addToCart(${product.productId})" class="btn-add-cart">
            ...
            <div class="text-center mt-4">
                <a href="${pageContext.request.contextPath}/shop" class="btn btn-outline-primary btn-lg">
