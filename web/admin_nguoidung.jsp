                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100 transition-colors select-none">
                                            <a href="admin_nguoidung?action=list&sortBy=id&sortOrder=${currentSortBy == 'id' && currentSortOrder == 'asc' ? 'desc' : 'asc'}" class="flex items-center group w-full h-full">
                                                ID
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100 transition-colors select-none">
                                            <a href="admin_nguoidung?action=list&sortBy=fullname&sortOrder=${currentSortBy == 'fullname' && currentSortOrder == 'asc' ? 'desc' : 'asc'}" class="flex items-center group w-full h-full">
                                                Họ tên
                                                <span class="ml-1 inline-block w-4">
                                                    <c:choose>
                                                        <c:when test="${currentSortBy == 'fullname'}">
                                                            <i class="fas ${currentSortOrder == 'asc' ? 'fa-sort-up' : 'fa-sort-down'} text-blue-600"></i>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <i class="fas fa-sort text-gray-300 group-hover:text-gray-400"></i>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100 transition-colors select-none">
                                            <a href="admin_nguoidung?action=list&sortBy=email&sortOrder=${currentSortBy == 'email' && currentSortOrder == 'asc' ? 'desc' : 'asc'}" class="flex items-center group w-full h-full">
                                                Email
                                                <span class="ml-1 inline-block w-4">
                                                    <c:choose>
                                                        <c:when test="${currentSortBy == 'email'}">
                                                            <i class="fas ${currentSortOrder == 'asc' ? 'fa-sort-up' : 'fa-sort-down'} text-blue-600"></i>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <i class="fas fa-sort text-gray-300 group-hover:text-gray-400"></i>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer hover:bg-gray-100 transition-colors select-none">
                                            <a href="admin_nguoidung?action=list&sortBy=role&sortOrder=${currentSortBy == 'role' && currentSortOrder == 'asc' ? 'desc' : 'asc'}" class="flex items-center group w-full h-full">
                                                Vai trò
                                                <span class="ml-1 inline-block w-4">
                                                    <c:choose>
                                                        <c:when test="${currentSortBy == 'role'}">
                                                            <i class="fas ${currentSortOrder == 'asc' ? 'fa-sort-up' : 'fa-sort-down'} text-blue-600"></i>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <i class="fas fa-sort text-gray-300 group-hover:text-gray-400"></i>
