        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-slate-50 p-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Thêm Thương hiệu mới</h3>
                    ...
                    <form action="admin_thuonghieu" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="xuatXu" class="block text-sm font-medium text-gray-700">Xuất xứ</label>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Danh sách Thương hiệu</h3>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <c:forEach var="th" items="${thuongHieuList}">
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${th.id}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-700">${th.tenThuongHieu}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${th.xuatXu}</td>
                                        <td class="px-6 py-4 max-w-sm text-sm text-gray-500 truncate" title="${th.moTa}">
                                            ${th.moTa}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                            
                                            <a href="admin_thuonghieu?action=edit&id=${th.id}" 
                                               class="text-blue-600 hover:text-blue-900" title="Sửa">
                                                <i class="fas fa-edit fa-lg"></i>
                                            </a>
                                            
                                            <a href="admin_thuonghieu?action=delete&id=${th.id}" 
